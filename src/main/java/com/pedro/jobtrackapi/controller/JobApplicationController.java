...
public class JobApplicationController {
    ...
    @PostMapping
    public ResponseEntity<JobApplicationResponse> createJobApplication(@RequestBody CreateJobApplicationRequest createJobApplicationRequest) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<JobApplicationResponse> updateJobApplication(@PathVariable Long id, @RequestBody UpdateJobApplicationRequest updateJobApplicationRequest) {
